...
public class Job extends BaseModel{
    ...
    public JobDTOs jobToJobDTOs() {
        ...
        jobDTOs.setJobTitle(getJobTitle());
        jobDTOs.setCompany(getCompany());
        jobDTOs.setApplicants(getApplicants());
        jobDTOs.setAbout(getAbout());
        jobDTOs.setExperience(getExperience());
        jobDTOs.setJobType(getJobType());
        jobDTOs.setLocation(getLocation());
        jobDTOs.setPackageOffered(getPackageOffered());
        jobDTOs.setPostTime(getPostTime());
        jobDTOs.setDescription(getDescription());
        jobDTOs.setSkillsRequired(getSkillsRequired());
        jobDTOs.setJobStatus(getJobStatus());
        return jobDTOs;
    }
}
